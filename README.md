...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   the use routematch hook is used for the user when pressed on a link that the url will send and change the url. then it will switch to a new page once clicked on button or link.
1. How would you explain form validation to someone who has never programmed before?
   The validation is a way to send a message error to users. the errors could be all types of errors they could be that he must fill out his name or he must fill out his email.
1. In 1-2 sentences, define end to end testing.
   end to end testing is a method used to test functionality and performance of an application. and it tests it while the application is in a live setting under product live circumsances.
